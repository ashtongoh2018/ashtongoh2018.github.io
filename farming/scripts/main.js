...
async function approve1() {
  ...
  web3.eth.defaultChain = 'rinkeby';
  const tokenContract = new web3.eth.Contract(tokenContractABI, '0x4232e519a70f677c873979cd796e5e9a77d4A31d');
  tokenContract.methods.approve("0x59dF5C797dA1be66F9b0163622E8108d89067dda", a).send({ from: acc}, function(error, transactionHash){
...
async function claimReward(b) {
  ...
  web3.eth.defaultChain = 'rinkeby';
  const farmContract = new web3.eth.Contract(farmContractABI, '0x59dF5C797dA1be66F9b0163622E8108d89067dda');
  const count = await farmContract.methods.withdrawRewards(b).call();
